...
class TestUISingUpPage(TestBaseUi):
    ...
    def test_sign_up(self, open_and_close_browser_fixture):
        user = self.random_user.generate()
        ...
        assert WebDriverSingleton.wait_for_element(self.base_page.sing_up_url, self.base_page.contact_url, EC.url_changes), "User successfully sing up!"
