...
class TestContact:
    ...
    def test_cannot_create_contact_without_login(self):
        ...
        response = ApiClientBase.post_req(data=payload, postfix_url='/contacts',token=user_token_header)
    ...
    def test_cannot_add_contact_without_firstName_field(self, user_get_token_fixture):
        ...
        response = ApiClientBase.post_req(data=payload, postfix_url='/contacts',token=token)
